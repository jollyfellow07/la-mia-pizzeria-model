...
namespace PizzeriaCompagnone.Utils
{
    public static class DbPizza
    {
        ...
        public static List<Pizza> GetPizzas()
        {
            ...
            Pizza pizza6 = new Pizza(4, "Gialla Provola & pepe", "Pomodorini gialli del piennolo, provola di Agerola. pepe nero, olio extravergine aggiunto a fine cottura, basilico.", "gialla1.jpg", "gialla2.jpg", 13.00);
